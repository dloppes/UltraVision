...
public class StockRentedView extends JFrame implements ActionListener{
	...
	public StockRentedView() {
		...
		rentedTitlesLabel.setIcon(new ImageIcon(StockRentedView.class.getResource("/img/rented_icon.png")));
		rentedTitlesLabel.setForeground(new Color(189, 183, 107));
		rentedTitlesLabel.setBackground(new Color(0, 0, 0));
